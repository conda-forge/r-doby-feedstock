...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5178&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-doby-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-doby` can be installed with `conda`:
...
```
mamba install r-doby
```

It is possible to list all of the versions of `r-doby` available on your platform with `conda`:
...
```
mamba search r-doby --channel conda-forge
```
...
mamba repoquery search r-doby --channel conda-forge

# List packages depending on `r-doby`:
mamba repoquery whoneeds r-doby --channel conda-forge

# List dependencies of `r-doby`:
mamba repoquery depends r-doby --channel conda-forge
```
